...
public class QuestionControllerTest extends EndToEndTest {
    ...
    public void addQuestion() {
        ...
        ResponseEntity<Question> response = new AddQuestionApiCall().run(new AddQuestionCommand(expected), template, baseUrl);
    ...
    public void solveQuestion() {
        Question expected = testQuestions.random();
        Question question = new AddQuestionApiCall().run(new AddQuestionCommand(expected), template, baseUrl).getBody();
