...
import com.prodigy.diff.WordValueDiffChecker;
...
import com.prodigy.diff.DMPListDiffCalculator;
...
public class QuestionFeatureExtractor implements FeatureExtractor<Question> {
    ...
    private SentenceDiff getDiffFromQuestion(Question question) {
        ...
        SentenceDiffCheckerImpl diffChecker = new SentenceDiffCheckerImpl(new WordValueDiffChecker(new DMPListDiffCalculator()));
        return diffChecker.diff(sourceSent, targetSent);
    }
}
